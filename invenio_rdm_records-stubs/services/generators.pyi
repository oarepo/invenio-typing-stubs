...
class IfRestricted(ConditionalGenerator):
    ...
    def query_filter(self, **kwargs: Any) -> Any: ...
...
class IfRecordDeleted(Generator):
    ...
    def needs(self, record: Any | None = ..., **kwargs: Any) -> Collection[Need]: ...
    def excludes(self, record: Any | None = ..., **kwargs: Any) -> Collection[Need]: ...
    def query_filter(self, **kwargs: Any) -> Any: ...

class RecordOwners(Generator):
    def needs(self, record: Any | None = ..., **kwargs: Any) -> Collection[Need]: ...
    def query_filter(self, identity: Identity | None = ..., **kwargs: Any) -> Any: ...
...
class ResourceAccessToken(Generator):
    ...
    def needs(
        self, record: Any | None = ..., file_key: str | None = ..., **kwargs: Any
    ) -> Collection[Need]: ...
