...
class OAIPMHServerService(Service):
    ...
    def create(self, identity, data: dict[str, Any], uow: Any | None = None) -> Any: ...
    def read(self, identity, id_: int) -> Any: ...
    def search(self, identity, params: dict[str, Any]) -> Any: ...
    def update(
        self, identity, id_: int, data: dict[str, Any], uow: Any | None = None
    ) -> Any: ...
    def delete(self, identity, id_: int, uow: Any | None = None) -> bool: ...
