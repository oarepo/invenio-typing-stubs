...
class BaseWriter(ABC, metaclass=abc.ABCMeta):
    ...
    @abstractmethod
    def write(self, stream_entry: StreamEntry, *args: Any, **kwargs: Any) -> None: ...
    @abstractmethod
    def write_many(
...
class ServiceWriter(BaseWriter):
    ...
    def write(self, stream_entry: StreamEntry, *args, **kwargs) -> None: ...
    def write_many(self, stream_entries: list[StreamEntry], *args, **kwargs) -> int: ...
